...
void Main()
{
  ...
  var strategies = new List<INotificationStrategy> { NotificationFactory.Create("email")
...
{
  public static INotificationStrategy Create(string name)
    => name switch { "email"  => new EmailNotificationStrategy()
