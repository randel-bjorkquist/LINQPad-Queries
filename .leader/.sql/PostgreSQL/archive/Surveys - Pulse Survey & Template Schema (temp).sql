...
-- create index "IX_Template_IsPulse"
--     on leadr."Template" using hash ("IsPulse");
...
create index "IX_SurveySeries_TemplateID"
    on leadr."SurveySeries" using hash ("TemplateID");
--------------------------------------------------------------------------------
...
create index "IX_SurveySeriesSurvey_SurveySeriesID"
    on leadr."SurveySeriesSurvey" using hash ("SurveySeriesID");

create index "IX_SurveySeriesSurvey_SurveyID"
    on leadr."SurveySeriesSurvey" using hash ("SurveyID");
--------------------------------------------------------------------------------
...
create index "IX_QuestionSeries_SurveySeriesID"
    on leadr."QuestionSeries" using hash ("SurveySeriesID");
...
create index "IX_QuestionSeriesQuestion_QuestionSeriesID"
    on leadr."QuestionSeriesQuestion" using hash ("QuestionSeriesID");

create index "IX_QuestionSeriesQuestion_QuestionID"
    on leadr."QuestionSeriesQuestion" using hash ("QuestionID");
--------------------------------------------------------------------------------
