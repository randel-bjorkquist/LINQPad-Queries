...
void Main()
{
  ...
  var combined = EventType.InspectionSaved | EventType.FamilyCertSaved;
  combined.HasFlag(EventType.InspectionSaved).Dump("combined.HasFlag(mcsEventType.InspectionSaved)");
  combined.HasFlag(EventType.FamilyCertSaved).Dump("combined.HasFlag(mcsEventType.FamilyCertSaved)");
}

#region abstract TypedFlag(s) && interface(s) ITypedFlag

public interface ITypedFlag<TSelf, Tid>
...
public abstract class TypedFlag<TSelf, Tid> : IFormattable, ITypedFlag<TSelf, Tid>
  ...
  where Tid : notnull, IEquatable<Tid>, IComparable<Tid>
{
  ...
  ///   <item><c>"f"</c> → Alternative: Full verbose format: "ID, Description, Code"</item>
  ///   <item><c>"g"</c> → Alternative: General short format: "ID, Code"</item>
  ...
  public string ToString(string? format, IFormatProvider? provider = null)
  {
    return format switch
    {
      ...
      "f" => $"ID: {ID}, Description: {Description}, Code: {Code}", // Aternative: Full verbose format
      "g" => $"ID: {ID}, Code: {Code}",                             // Aternative: General / short + id
  ...
  public static bool operator == (TypedFlag<TSelf, Tid> left, TypedFlag<TSelf, Tid> right)
  ...
  public bool HasFlag(TSelf flag)
  {
    ...
    dynamic thisID = ID;
    dynamic flagID = flag.ID;
    
    return (thisID & flagID) == flagID;
  }
  
  //protected static TypedFlag<TSelf, Tid> None = (TSelf)Activator.CreateInstance(typeof(TSelf), default(Tid), "None", nameof(None));
  
  /// <summary>
  /// Combines two TypedEnum values using bitwise OR.
  /// </summary>
  public static TypedFlag<TSelf, Tid> operator | (TypedFlag<TSelf, Tid> left, TypedFlag<TSelf, Tid> right)
  {
    if (left  is null) return right ?? default(TSelf);
    //if (left  is null) return right ?? None;
    if (right is null) return left;
    
    if (!typeof(Tid).IsValueType || typeof(Tid) == typeof(string))
      throw new InvalidOperationException($"Bitwise operators are not supported for this '{typeof(Tid)}' type.");
    
    dynamic _ids         = (dynamic)left.ID | (dynamic)right.ID;
    string _descriptions = $"{left.Description} | {right.Description}";
    string _codes        = $"{left.Code} | {right.Code}";
    
    //return (TSelf)Activator.CreateInstance(typeof(TSelf), _ids, _descriptions, _codes);
    return (TSelf)Activator.CreateInstance( typeof(TSelf)
                                           ,bindingAttr: BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic
                                           ,binder: null
                                           ,args: new object[] {_ids, _descriptions, _codes}
                                           ,culture: null)!;
  }
  
  /// <summary>
  /// Intersection of two TypedEnum values using bitwise AND.
  /// </summary>
  public static TypedFlag<TSelf, Tid> operator & (TypedFlag<TSelf, Tid> left, TypedFlag<TSelf, Tid> right)
  {
    if (left is null || right is null) return default(TSelf);
    //if (left is null || right is null) return None;
    ...
    string _descriptions = $"{left.Description} & {right.Description}";
    string _codes        = $"{left.Code} & {right.Code}";
    //string _descriptions = $"Intersection ({_ids})";
    //string _codes        = $"AND";
  ...
  /// <summary>
  /// Computes the exclusive OR of two TypedEnum values.
  /// </summary>
  public static TypedFlag<TSelf, Tid> operator ^(TypedFlag<TSelf, Tid> left, TypedFlag<TSelf, Tid> right)
  {
    if (left is null || right is null) return default(TSelf);
  ...
  where Tself : TypedFlagInt16<Tself>
{
  ...
  public static implicit operator Int16(TypedFlagInt16<Tself> type)
  ...
  public static implicit operator string(TypedFlagInt16<Tself> type)
  ...
  where Tself : TypedFlagInt32<Tself>
{
  ...
  public static explicit operator TypedFlagInt32<Tself>(int id)
    => GetByID(id);
    
  // EventType -> int (implicit or explicit)
  [Obsolete("Prefer mcsEventType.Field.ID for clarity and future-proofing.", false)]
  public static implicit operator int(TypedFlagInt32<Tself> type)
    => type is null ? throw new ArgumentNullException(nameof(type)) : type.ID;
  
  [Obsolete("Prefer mcsEventType.Field.Description for clarity and future-proofing.", false)]
  public static implicit operator string(TypedFlagInt32<Tself> type)
    => type is null ? throw new ArgumentNullException(nameof(type)) : type.Description;
  ...
  where Tself : TypedFlagInt64<Tself>
{
  ...
  [Obsolete("Prefer mcsEventType.Field.ID for clarity and future-proofing.", false)]
  public static implicit operator Int64(TypedFlagInt64<Tself> type)
    => type is null ? throw new ArgumentNullException(nameof(type)) : type.ID;
  
  [Obsolete("Prefer mcsEventType.Field.Description for clarity and future-proofing.", false)]
  public static implicit operator string(TypedFlagInt64<Tself> type)
    => type is null ? throw new ArgumentNullException(nameof(type)) : type.Description;
  ...
  where Tself : TypedFlagInt128<Tself>
{
  ...
  [Obsolete("Prefer mcsEventType.Field.ID for clarity and future-proofing.", false)]
  public static implicit operator Int128(TypedFlagInt128<Tself> type)
    => type is null ? throw new ArgumentNullException(nameof(type)) : type.ID;
  
  [Obsolete("Prefer mcsEventType.Field.Description for clarity and future-proofing.", false)]
  public static implicit operator string(TypedFlagInt128<Tself> type)
    => type is null ? throw new ArgumentNullException(nameof(type)) : type.Description;
...
// guid ---------------------------------------------------------------------------------
public abstract class TypedFlagGuid<Tself> : TypedFlag<Tself, Guid>
  where Tself : TypedFlagGuid<Tself>
{
  protected TypedFlagGuid(Guid id, string description, string code)
    : base(id, description, code) { }
  ...
  public static explicit operator TypedFlagGuid<Tself>(Guid id)
    => GetByID(id);
    
  // EventType -> guid (implicit or explicit)
  [Obsolete("Prefer mcsEventType.Field.ID for clarity and future-proofing.", false)]
  public static implicit operator Guid(TypedFlagGuid<Tself> type)
    => type is null ? throw new ArgumentNullException(nameof(type)) : type.ID;
  
  [Obsolete("Prefer mcsEventType.Field.Description for clarity and future-proofing.", false)]
  public static implicit operator string(TypedFlagGuid<Tself> type)
    => type is null ? throw new ArgumentNullException(nameof(type)) : type.Description;
...
public sealed class EventType : TypedFlagInt<EventType>
{
...
//  public static readonly EventType phaFileSaved                               = new( 52, "PHA File Saved"                                            ,nameof(phaFileSaved)); // COMMENTED OUT in 'enum'
  public static readonly EventType MaFormSaved                                = new( 53, "MaForm Saved"                                              ,nameof(MaFormSaved));
//  public static readonly EventType StMaUnitSaved                              = new( 54, "General Certification Unit Saved"                          ,nameof(StMaUnitSaved));  // NOT FOUND in the 'eventTypeDescription's Select Case statement
...
//  public static readonly EventType FamilyCertSubmissionFileSaved              = new( 57, "50058 Submission File"                                     ,nameof(FamilyCertSubmissionFileSaved));  // COMMENTED OUT in 'enum'
...
//  public static readonly EventType distributionSaved                          = new( 74, "Distribution Saved"                                        ,nameof(distributionSaved));  // NOT FOUND in the 'eventTypeDescription's Select Case statement
//  public static readonly EventType stCtUnitSaved                              = new( 75, "stCtUnitSaved"                                             ,nameof(stCtUnitSaved));  // COMMENTED OUT in 'enum'
...
//  public static readonly EventType orderingProductSaved                       = new(143, "Forms Ordering Product Saved"                            ,nameof(orderingProductSaved));  // COMMENTED OUT in 'enum'
//  public static readonly EventType orderingOrderSaved                         = new(144, "Forms Ordering Order Saved"                              ,nameof(orderingOrderSaved));  // COMMENTED OUT in 'enum'
//  public static readonly EventType orderingOrderDetailsSaved                  = new(145, "Forms Ordering Order Details Saved"                      ,nameof(orderingOrderDetailsSaved));  // COMMENTED OUT in 'enum'
...
//  public static readonly EventType familyNotificationSetupSaved               = new(182, "Family Notification Setup Saved"                           ,nameof(familyNotificationSetupSaved)); // NOT FOUND in the 'eventTypeDescription's Select Case statement
...
//  public static readonly EventType phaFamilyPortalPermissionSetup             = new(200, "Family Portal Permission Setup"                            ,nameof(phaFamilyPortalPermissionSetup));  // COMMENTED OUT in 'enum'
...
//  public static readonly EventType phaWebsiteSetupSaved                       = new(287, "PHA Website Setup Saved"                                   ,nameof(phaWebsiteSetupSaved)); // NOT FOUND in the 'eventTypeDescription's Select Case statement
...
//  public static readonly EventType glAccountLabelSaved                        = new(298, "Financial Account Label Saved"                             ,nameof(glAccountLabelSaved)); // COMMENTED OUT in 'enum'
